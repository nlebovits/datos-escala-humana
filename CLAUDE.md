...
uv run quarto preview      # Preview book at localhost:4200
uv run quarto render       # Build the book
```
...
| "as quarto formatter" | `.agents/quarto-formatter.md` |
