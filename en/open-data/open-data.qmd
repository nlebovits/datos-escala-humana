...
And cloud-native geospatial tools aren't some fancy, cutting-edge tech; they are
increasing the standard tools of the geospatial world, offering improved performance not
only for large datasets in cloud storage, but also for simple, local workflows, thanks
to their improved compression and speed. The cloud is simply one of the places where
people compute today. As mentioned in [the
introduction](../intro.qmd#guiding-principles), this book takes the cloud-native
