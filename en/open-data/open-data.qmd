...
footprints to compare to RENABAP data in La
Plata](https://nlebovits.github.io/ciut-riesgo/renabap.html). Our findings were stark:
the RENABAP data may underestimate the real population in these settlements by roughly
40%. In one extreme case, we found an informal settlement that RENABAP estimated was
inhabited by 330 families--but satellite imagery showed that it contained more than
*four thousand building footprints*.
