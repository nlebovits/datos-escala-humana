...
We'd like to conclude this chapter with a tangible illustration of the value of open
data--specifically, open *global* data. Generally, it's assumed that local data are
better (more accurate, more recent, etc.) than global data.
