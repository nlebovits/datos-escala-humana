...
is found on the internet. It can be a catalog, server, web application, list of pages,
or layers. A well-organized SDI makes it easy to find, access, and use open data, but
not all SDIs are created equal. In this chapter, we'll talk about navigating the SDI
